...
class RapidCleaner:
    """Агрессивная очистка – удаляем прокси, не работающие в последние 30 минут"""
...
║{Fore.WHITE}         Удаляем прокси, не работающие > 30 минут       {Fore.CYAN}║
...
╚══════════════════════════════════════════════════════════╝{Style.RESET_ALL}
        ...
        # Проверяем только те, которые не проверялись последние 30 минут
        now = datetime.now()
        need_check = []
